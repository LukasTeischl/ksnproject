...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.variable_qtgui_range_1 = variable_qtgui_range_1 = 100m
        self.samp_rate = samp_rate = 32000
        self.frequ = frequ = 105.6 M

        ##################################################
        # Blocks
        ##################################################

        self._variable_qtgui_range_1_range = qtgui.Range(0, 100, 1, 100m, 0)
        ...
        self.uhd_usrp_source_0.set_samp_rate(4M)
        self.uhd_usrp_source_0.set_time_unknown_pps(uhd.time_spec(0))

        self.uhd_usrp_source_0.set_center_freq(105.6M, 0)
        ...
        self._frequ_range = qtgui.Range(90M, 110M, 1, 105.6 M, 200)
        self._frequ_win = qtgui.RangeWidget(self._frequ_range, self.set_frequ, "'frequ'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._frequ_win)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, , 0, samp_rate)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(100m)
